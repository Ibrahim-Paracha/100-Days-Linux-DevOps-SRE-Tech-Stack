...
| Task | Title |
|------|--------|
| 1 | [Landing Page and Linux Module](#task-1-click-on-the-landing-page-and-select-the-linux-module) |
| 2 | [Select the Linux Module](#task-2-select-the-linux-module) |
...
If you want to come back later and start all over, click "NEXT" until you reach this final screen and click on "Scenario"

<img src="../../.github/assets/intro6_killercoda.jpeg" width="250">

---

You will be given the option to "Exit" so click on it.

If you want to come back and start all over do so.
...
Post on your LinkedIn account about your 12th Day at Working in Nexus (NIT).
